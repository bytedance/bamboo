...
class ExpNormalSmearing(nn.Module):
    def __init__(self, cutoff_lower=0.0, cutoff_upper=5.0, num_rbf=32, trainable=True, device=torch.device("cpu")):
    ...
    def _initial_params(self):
        ...
        means = torch.linspace(start_value, 1, self.num_rbf).to(self.device)
        betas = torch.tensor(
